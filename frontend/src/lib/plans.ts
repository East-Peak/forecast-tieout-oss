...
type PlanArrGrain = "monthly" | "quarterly" | "annual";
type PlanSeatGrain = "monthly" | "quarterly" | "annual";
type PlanTreatmentClass = "operator_comparable" | "executive_reference";
type PlanModeledStatus = "scenario_modeled" | "held_assumption";
...
interface NormalizedValueFamily {
...
interface NormalizedSeatValueFamily {
